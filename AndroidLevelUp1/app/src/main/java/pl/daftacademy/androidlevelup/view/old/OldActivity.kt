package pl.daftacademy.androidlevelup.view.old
...
import pl.daftacademy.androidlevelup.view.old.recycler.OldAdapter
...
class OldActivity : AppCompatActivity() {
    ...
    private val adapter = OldAdapter()
    ...
    private fun initToolbar() {
        ...
        supportActionBar?.title = "Relative/Linear Layout"
    }

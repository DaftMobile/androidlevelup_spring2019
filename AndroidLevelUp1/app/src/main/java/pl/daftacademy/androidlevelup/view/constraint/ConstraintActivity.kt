package pl.daftacademy.androidlevelup.view.constraint
...
import pl.daftacademy.androidlevelup.view.constraint.recycler.ConstraintAdapter
...
class ConstraintActivity : AppCompatActivity() {
    ...
    private val adapter = ConstraintAdapter()
    ...
    private fun fetchRestaurantsInWarsaw() {
        zomatoFetcher.fetchRestaurantsInWarsaw().enqueue(object : Callback<SearchRestaurantsResponse> {
            override fun onResponse(
                call: Call<SearchRestaurantsResponse>,
                response: Response<SearchRestaurantsResponse>
            ) {
